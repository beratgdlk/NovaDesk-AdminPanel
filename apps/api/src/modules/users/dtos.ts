import { Gender, Prisma } from "@onlyjs/db/client";
...
const recordStatusEnum = t.Union([
  t.Literal("ACTIVE"),
  t.Literal("DELETED"),
  t.Literal("ALL"),
]);
...
export const userResponseSchema = t.Object({
  ...
  agentUuid: UserPlain.properties.agentUuid,
  agent: t.Nullable(
    t.Object({
      uuid: t.String(),
      name: t.String(),
...
export const userUpdateDto = {
  ...
  body: t.Object({
    ...
    agentUuid: t.Optional(UserPlain.properties.agentUuid),
  }),
  response: {
    200: userResponseSchema,
    404: errorResponseDto[404],
